    ...
    ?>
     ...
     <?php
       ...
       <div class="open-contents">
        ...
        <form class="form-style-9" action="mainhomepage.php">
        <ul>
...
<li>
  <label for="field40"style="float: right;">تعداد مورد نیاز</label> <input tttonype="number" name="field40"    id="field40"    class="field-style field-split align-right " style="direction:rtl;"/>
...
<li>
<button onclick="displayInfo()"  class="buttons">ذخیره  </button></li>
...
<li>
<button class="buttons" onclick="displayInfo() " >ذخیره </button>
  </li>
...
<?php
	...
	<script>
		function displayInfo(){
			alert("لطفا ابتدا ثبت نام کنید");  // display string message

...
<nav class="navbar" >
    ...
    <div class="wrap">
      <div class="right-menu">
        <a class="active"  href="adminprofile.php"><img src="../photo/person.png"style="width:60% "><i class="fa"style="font-size:25px"></i><span style="font-size:25px">پروفایل</span></a>
